TARGETS = Rand.exe EDF.exe EDZL.exe LLF.exe LMCF.exe LMCLF_no1.exe LMCLF_no1_a.exe LMCLF_no1_a2.exe LMCLF_no1_a3.exe LMCLF_MP.exe LMCLF_MP_LIST.exe LMCLF_no2.exe LMCLF_no3.exe AcII_LMCF.exe AcII_LMCLF_no1.exe AcII_LMCLF_no2.exe AcII_LMCLF_no3.exe LLF_LMCLF_no1.exe LLF_LMCLF_no2.exe LLF_LMCLF_no3.exe LLF_AcII_LMCLF_no1.exe LLF_AcII_LMCLF_no2.exe LLF_AcII_LMCLF_no3.exe Result.exe

OBJS = Rand.o EDF.o EDZL.o LLF.o LMCF.o LMCLF_no1.o LMCLF_no1_a.o LMCLF_no1_a2.o LMCLF_no1_a3.o LMCLF_MP.o LMCLF_MP_LIST.o LMCLF_no2.o LMCLF_no3.o AcII_LMCF.o AcII_LMCLF_no1.o AcII_LMCLF_no2.o AcII_LMCLF_no3.o LLF_LMCLF_no1.o LLF_LMCLF_no2.o LLF_LMCLF_no3.o LLF_AcII_LMCLF_no1.o LLF_AcII_LMCLF_no2.o LLF_AcII_LMCLF_no3.o Result.o
